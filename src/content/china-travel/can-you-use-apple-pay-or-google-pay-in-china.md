...
tags: ["Apple Pay", "Google Pay", "payment"]
officialSources: ["gov-payment-guide-2024", "apple-pay-setup-2026", "apple-pay-where-to-use-2026", "google-wallet-supported-countries-2026", "google-wallet-pay-in-store-2026"]
relatedTools: []
---
...
They may help in places that already look card-terminal friendly:

- international hotels,
- airports,
- some larger malls,
- some international-facing restaurants,
- some stores with supported contactless terminals.

Even there, acceptance may vary by your card issuer, device setup, network, and the merchant's terminal.

## Where They Usually Fail

They are much less useful when the merchant expects:

- Alipay or WeChat Pay QR payment,
- a restaurant QR menu,
- a mini-program checkout,
- a small local shop counter,
- a taxi or ride-hailing app flow,
- a food stall or simple local payment setup.

If the merchant is built around QR payment, a Western phone wallet may not solve the problem.
...
## What Tourists Should Prepare Instead

Prepare a local-payment backup stack:

1. Alipay as your first app to test.
2. WeChat Pay as a second route if setup works.
3. One physical international card.
4. A small amount of RMB cash.
5. Reliable mobile data.
